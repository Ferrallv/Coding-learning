...
// Implementing our geometry interface on `rect` and 
// `circle` types
...
// `methods` that are in the named interface. Here we see
// a generic measure function taking advantage of this to
// work on any `geometry`
