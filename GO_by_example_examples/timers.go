...
or repeatedly at some interval. Go's built0in timer and
ticker features make both of these tasks easy. We'll look 
first at timers and the at tickers.
*/ 
...
func main() {
	// Timers represent a sinle event in the future. You
	// tell the timer how long you want to wait, and it 
	// provides a channel that will be notified at that
	// time. 
	timer1 := time.NewTimer(2 * time.Second)

	// The <-timer1.C blocs on the timer's channel C
