...
future - tickers are for when you want to do soemthing 
repeatedly at regular intervals. Here's an example of a 
ticker that ticks peridocally until we stop it.
*/ 
...
func main() {
	...
	// on the channel to await the values as they arrive every
	// 500ms
